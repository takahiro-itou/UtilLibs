...
If ( NOT ( "${LIBRARY_SOURCE_FILES}" STREQUAL "" ) )
    ##  通常通りライブラリファイルを生成する。
    Add_Library (${MODULE_TARGET_NAME}  ${LIBRARY_SOURCE_FILES})
    ...
    Set_Property (TARGET   ${MODULE_TARGET_NAME}
...
install (EXPORT        ${MODULE_TITLE}-Export
...
export  (TARGETS       ${MODULE_TARGET_NAME}
        EXPORT         ${MODULE_TITLE}-BuildTree-Export
        FILE           ${PROJECT_NAME}-${MODULE_TITLE}-Export.cmake
        EXPORT_LINK_INTERFACE_LIBRARIES
)
